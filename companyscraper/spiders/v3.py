...
class V3Spider(CrawlSpider):
    name = "v3"
    allowed_domains = ["konrad.com", "www.konrad.com", "slalom.com", "www.slalom.com"]
    start_urls = ["https://www.slalom.com/us/en"]
    ...
    rules = (
        ...
        Rule(LinkExtractor(allow=(r"/.*"), allow_domains=('konrad.com',), deny_domains=('jobs.slalom.com',),), callback='parse_item', follow=True),
